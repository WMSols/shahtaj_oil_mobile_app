...
class RmHistoryContent extends GetView<RmHistoryController> {
  const RmHistoryContent({super.key});
      ...
      children: [
        Padding(
          ...
          child: AppSearchField(
            key: const ValueKey('rm_history_search'),
            hint: AppTexts.rmSearchCollectionHint,
        ...
        Obx(
          () => SingleChildScrollView(
            ...
            child: Row(
              children: [
                for (final method in RmHistoryController.methodFilters)
                  AppFilterChip(
          ...
          child: Obx(() {
            ...
            return AppAsyncBody(
              ...
              emptySubtitle: hasQuery || isFiltered || controller.hasDateFilter
                  ? AppTexts.rmNoCollectionsMatchSearch
                  : AppTexts.rmNoRecentCollections,
