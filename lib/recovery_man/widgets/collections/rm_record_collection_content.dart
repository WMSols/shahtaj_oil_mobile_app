...
import 'package:shahtaj_oil_mobile_app/recovery_man/widgets/collections/rm_collect_invoice_row.dart';

class RmRecordCollectionContent extends GetView<RmRecordCollectionController> {
  const RmRecordCollectionContent({super.key});
    ...
    return Obx(() {
      ...
      if (shop == null) {
        return AppEmptyState(
          ...
          subtitle: AppTexts.rmRecordCollectionTitle,
            ...
            child: ListView(
              ...
              children: [
                ...
                AppFormSectionHeader(
                  ...
                  title: AppTexts.rmPaymentMethod,
                ),
                AppSpacing.vertical(context, 0.012),
                Obx(() {
                    ...
                    children: [
                      ...
                      if (selected == PaymentMethod.cheque) ...[
                        ...
                        AppTextField(
                          ...
                          label: AppTexts.rmChequeNumber,
                          hint: AppTexts.rmChequeNumberHint,
                          required: true,
                          textInputAction: TextInputAction.next,
                        ),
                      ],
                      if (selected == PaymentMethod.bank) ...[
                        ...
                        AppTextField(
                          controller: controller.referenceController,
                          label: AppTexts.rmBankReference,
                          hint: AppTexts.rmBankReferenceHint,
                          required: true,
                          textInputAction: TextInputAction.next,
                        ),
                        AppSpacing.vertical(context, 0.016),
                ...
                AppTextField(
                  ...
                  label: AppTexts.rmCollectionNotes,
                  hint: AppTexts.rmCollectionNotesHint,
                  maxLines: 3,
                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      AppSpacing.vertical(context, 0.012),
                      AppPrimaryButton(
                        label: AppTexts.rmConfirmCollection,
