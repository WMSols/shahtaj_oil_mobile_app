...
class DmRecentCollectionsCard extends StatelessWidget {
  const DmRecentCollectionsCard({
    super.key,
    required this.collections,
    this.onCollectionTap,
  });

  final List<DmCollectionSummaryModel> collections;
  final ValueChanged<DmCollectionSummaryModel>? onCollectionTap;
