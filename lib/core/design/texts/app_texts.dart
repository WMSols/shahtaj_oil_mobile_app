...
class AppTexts {
  ...
  static String get reportsTitle => 'reportsTitle'.tr;
  static String get reportCreateTitle => 'reportCreateTitle'.tr;
  static String get reportDetailTitle => 'reportDetailTitle'.tr;
  static String get reportSubjectLabel => 'reportSubjectLabel'.tr;
  static String get reportSubjectHint => 'reportSubjectHint'.tr;
  static String get reportDescriptionLabel => 'reportDescriptionLabel'.tr;
  static String get reportDescriptionHint => 'reportDescriptionHint'.tr;
  static String get reportTagsLabel => 'reportTagsLabel'.tr;
  static String get reportScreenshotLabel => 'reportScreenshotLabel'.tr;
  static String get reportScreenshotHint => 'reportScreenshotHint'.tr;
  ...
  static String get reportAttachmentLabel => 'reportAttachmentLabel'.tr;
  static String get reportSearchHint => 'reportSearchHint'.tr;
  static String get reportNoSearchMatches => 'reportNoSearchMatches'.tr;
  static String get reportStateNew => 'reportStateNew'.tr;
  static String get reportStateInProgress => 'reportStateInProgress'.tr;
  static String get reportStateDone => 'reportStateDone'.tr;
  static String get reportStateCancelled => 'reportStateCancelled'.tr;
  static String get reportStateAll => 'reportStateAll'.tr;
  static String get reportSent => 'reportSent'.tr;
  static String get reportQueued => 'reportQueued'.tr;
  static String get reportNeedSubject => 'reportNeedSubject'.tr;
  static String get reportNeedDescription => 'reportNeedDescription'.tr;
  static String get reportNeedTag => 'reportNeedTag'.tr;
  static String get reportPendingSync => 'reportPendingSync'.tr;
  static String get emptyNoReportsTitle => 'emptyNoReportsTitle'.tr;
  static String get emptyNoReportsSubtitle => 'emptyNoReportsSubtitle'.tr;
  static String get syncQueuedReportCreate => 'syncQueuedReportCreate'.tr;
